...
class ChangePasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final optionWidgetController = Get.put(OptionWidgetController());
                          ...
                          child: ElevatedButton(
                              onPressed: () {
                                if (formKey.currentState!.validate()) {
                                  ChangedPasswordModel changedPasswordModel = ChangedPasswordModel(
                                    email: optionWidgetController.emailController.text,
                                    password: changePassController.passwordController.text, 
                                    confirmPassword: changePassController.confirmPasswordController.text
                                  );

                                  changePassController.resetPass(changedPasswordModel, context);
                                }
                              },
