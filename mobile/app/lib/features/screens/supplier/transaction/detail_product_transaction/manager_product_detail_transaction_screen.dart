...
class ManagerProductDetailTransactionScreen extends StatefulWidget {
  const ManagerProductDetailTransactionScreen({super.key});

  @override
  State<ManagerProductDetailTransactionScreen> createState() => _ManagerProductDetailTransactionScreenState();
}

class _ManagerProductDetailTransactionScreenState extends State<ManagerProductDetailTransactionScreen> {
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: ()  {
                  ...
                  controller.updateStatusTransaction(status, context);
                },
              ) : const SizedBox(),
            ],
          ),
