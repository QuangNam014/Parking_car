...
class GetDataSupplierStatusModel {
  final int id;
  ...
  factory GetDataSupplierStatusModel.fromJson(Map<String, dynamic> json) {
    return GetDataSupplierStatusModel(
      id: json['id'] ?? 0,
